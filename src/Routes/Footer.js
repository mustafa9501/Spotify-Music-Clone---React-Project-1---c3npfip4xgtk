    ...
    <>
      <div className="flex flex-col md:flex-row justify-between md:space-x-8 ml-6 mt-10">
        <div className="flex flex-col mb-4 md:mb-0 md:w-1/4">
          ...
          <div className="text-zinc-400 text-sm font-medium cursor-pointer hover:text-white mt-3 hover:underline">About</div>
        ...
        <div className="flex flex-col mb-4 md:mb-0 md:w-1/4">
          ...
          <div className="text-zinc-400 text-sm font-medium cursor-pointer hover:underline hover:text-white mt-3">For Artists</div>
          ...
          <div className="text-zinc-400 text-sm font-medium cursor-pointer hover:underline hover:text-white mt-1.5">Vendors</div>
        </div>
        <div className="flex flex-col mb-4 md:mb-0 md:w-1/4">
          <div className="text-white font-bold">Useful links</div>
          <div className="text-zinc-400 text-sm font-medium cursor-pointer hover:underline hover:text-white mt-3">Support</div>
